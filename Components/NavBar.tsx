    ...
    <nav
      ...
      <div
        ...
        <div className={" lg:block lg:pl-5 md:block  sm:block xsm:block"}>
          <Link href={"/"}>
            <Image
              ...
              width={160}
              height={100}
              className="min-w-[200px] max object-contain"
        ...
        <div className={"lg:block sm:hidden xsm:hidden "}>
          <ul
            className={"flex flex-row justify-center items-center gap-5 py-5"}>
            ...
            <li className={"grid grid-cols-2 gap-4 uppercase"}>
              <div
                className={
                  "col-span-2 row-span-2 font-medium text-white text-base flex gap-2 items-center"
                }>
                <FaWhatsapp size={30} />
            ...
            <li className={"grid grid-cols-4 gap-4 lowercase"}>
              <div
                className={
            ...
            <li className="grid grid-cols-1">
              <a href="https://www.linkedin.com/company/ambsi/">
                <FaLinkedin size={25} />
              </a>
            </li>
          </ul>
      ...
      <div
        className={
          "lg:w-full lg:py-3 lg:flex lg:items-center justify-center text-white md:hidden sm:hidden xsm:hidden lg:bg-secondaryAmbsi"
        }>
        <Navigation />
      </div>
