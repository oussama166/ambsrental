  ...
  return (
    <NavigationMenu>
      <NavigationMenuList className={"h-full"}>
        <NavigationMenuItem>
          <NavigationMenuTrigger
            className={"text-black bg-transparent font-bold text-base "}>
            Accueil
          </NavigationMenuTrigger>
          <NavigationMenuContent>
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger
            className={cn(
              "text-black bg-transparent font-bold text-base  active:text-red-500",
        ...
        <NavigationMenuItem>
          <Link href="/Transport" legacyBehavior passHref>
            <NavigationMenuLink
              className={cn(
                navigationMenuTriggerStyle(),
                "bg-transparent text-black font-bold text-base",
