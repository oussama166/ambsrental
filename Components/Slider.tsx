  ...
  const images = [
    {
      ...
      description:
        "Votre partenaire de confiance pour l'achat et la location de matèriels et équipements industriels au Maroc et en Afrique",
    },
  ];
  // End Data
      ...
      {images.map((img, idx) => (
        <div key={`${idx}_1`} className="w-full h-full keen-slider__slide">
          <div
            ...
            <div className={"absolute top-5 right-[100px] object-left"}>
              <Image
                src={img.title}
                alt={"idx"}
                height={200}
              ...
              <h1
                className={
                  "max-w-[400px] overflow-hidden break-words font-semibold"
                }>
                {img.description}
              </h1>
            </div>
